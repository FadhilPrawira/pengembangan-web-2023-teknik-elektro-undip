		...
		<div class="container my-5">
			...
			<?php echo form_open('pegawai/search'); ?>
				<div class="input-group my-3">
					<span class="input-group-text" id="basic-addon2">Nama Pegawai:</span>
			...
			<?php if(isset($search_result) and count($search_result)>=1):?><div class="search-result container">
				...
				<table border="1" class="table table-striped table-hover table-bordered rounded-5">
					...
					<tbody>	
				<?php $nomor = 1;foreach ($search_result as $employee):?>
		<tr>
							<td class="text-center"><?= html_escape($nomor).".";?></td>
							<td><?= html_escape($employee->Nomorpegawai_057);?></td>
							<td><?= html_escape($employee->NamaPegawai_057);?></td>
							<td><?= html_escape($employee->Unit_057);?></td>
							<td><?= html_escape($employee->Alamat_057);?></td> 
							<td><?= html_escape($employee->Nohp_057);?></td>     
						</tr>
